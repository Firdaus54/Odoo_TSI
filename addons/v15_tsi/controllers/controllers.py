...
class ControllerInherit(ReportController):
    ...
    def report_routes(self, reportname, docids=None, converter=None, **data):
        ...
        if converter == 'pdf' and report.populating_ms_word_template:
            ...
            return super(ControllerInherit, self).report_routes(reportname,docids,converter,**data)
        ...
        try:
            if type in ['qweb-pdf', 'qweb-text']:
                ...
                if not report.populating_ms_word_template:
                    return super(ControllerInherit, self).report_download(data, token)
                if report.type_export == 'pdf':
                    extension = 'pdf'
                else:
                    extension = 'docx'
