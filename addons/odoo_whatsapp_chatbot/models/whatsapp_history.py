            ...
            if (
                        ...
                        if not self.env.context.get("whatsapp_application"):
                            if (
                                ...
                                for component in wa_template.components_ids:
                                    ...
                                    ].search_read([("id", "=", active_model_id)])[0]
                                    ...
                                    if component.type in ["body", "footer"]:
                                        ...
                                        for length, var in zip(
                                            range(variables_length),
                                            component.variables_ids,
                                        ):
                                    ...
                                    if component.type == "header":
                                        ...
                                        if component.formate == "media":
                                            ...
                                            if (
                                                ...
                                                component.formate_media_type == "static"
                                            ):
                                                if component.media_type == "document":
                ...
                if vals.get("message") and vals.get("type") == "received":
                    ...
                    if provider_id.company_id and provider_id.company_id.wa_chatbot_id:
                        ...
                        if (
                            provider_id.company_id.wa_chatbot_id
                                ...
                                .search(
                                    [
                                        (
                                            "id",
                                            "=",
                                            provider_id.company_id.wa_chatbot_id.id,
                                        )
                                    ]
                                )
                                .mapped("step_type_ids")
                            ...
                            if (
                                not chatbot_script_lines
                                and provider_id.company_id.wa_chatbot_id.step_type_ids
                            ):
                                chatbot_script_lines = (
                                    provider_id.company_id.wa_chatbot_id.step_type_ids[
                                        0
                                    ]
                                )
                                                    ...
                                                    if active_operator:
                                                        ...
                                                        for (
                                                            ...
                                                            operators = active_operator.filtered(
                                                                ...
                                                                not in wa_channel.channel_last_seen_partner_ids.partner_id
                                                            )
                                                            if operators:
                                                                for (
                                                                    operator
