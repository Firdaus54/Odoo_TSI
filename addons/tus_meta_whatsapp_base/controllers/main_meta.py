...
class WebHookMeta(http.Controller):
    ...
    def get_channel(self, partner_to, provider):
        ...
        provider_channel_id = partner.channel_provider_line_ids.filtered(
            lambda s: s.provider_id == provider
        )
        if provider_channel_id:
            channel = provider_channel_id.channel_id
            if (
                request.env.user.partner_id.id not in channel.channel_partner_ids.ids
                and request.env.user.has_group("base.group_user")
            ):
                channel.sudo().write(
                    {"channel_partner_ids": [(4, request.env.user.partner_id.id)]}
                )
        else:
    ...
    def meta_webhook(self, **kw):
        ...
        # channel = self.get_channel([int(user_partner.id)], provider)
                ...
                if data.get("entry")[0].get("changes")[0].get("value"):
                    if (
                        ...
                        for acknowledgment in (
                            ...
                            wp_msgs = (
                                request.env["whatsapp.history"]
                                .sudo()
                                .search(
                                    [("message_id", "=", acknowledgment.get("id"))],
                                    limit=1,
                                )
                            )
                            if wp_msgs:
                                    ...
                                    .search(
                                        [
                                            ...
                                            (
                                                "phone",
                                                "=",
                                                acknowledgment.get("recipient_id"),
                                            ),
                                            (
                                                "mobile",
                                                "=",
                                ...
                                if wp_msgs:
                                    if acknowledgment.get("status") == "sent":
                                        ...
                                        wp_msgs.sudo().write(
                                            {
                                                "type": "fail",
                                                "fail_reason": acknowledgment.get(
                                                    "errors"
                                                )[0].get("title"),
                                            }
                                        )
                                ...
                                if wa_mail_message:
                                    if acknowledgment.get("status") == "sent":
                                        ...
                                        wa_mail_message.write(
                                            {
                                                "wp_status": "fail",
                                                "wa_delivery_status": acknowledgment.get(
                                                    "status"
                                                ),
                                                "wa_error_message": acknowledgment.get(
                                                    "errors"
                                                )[0]
                                                .get("error_data")
                                                .get("details"),
                        ...
                        if (
                            ...
                            for mes in (
                                ...
                                if not partners:
                                    ...
                                    country_code = region_code_for_country_code(
                                        pn.country_code
                                    )
                                    country_id = (
                                ...
                                for partner in partners:
                                    ...
                                    if mes.get("type") == "text":
                                        ...
                                        vals = {
                                            "message": "<a href='https://www.google.com/maps/search/?api=1&query="
                                            + str(lat)
                                            + ","
                                            + str(lag)
                                            + "' target='_blank' class='btn btn-primary'>Google Map</a>",
                                            "message_id": messages_id,
                                            "author_id": user_partner.id,
                                            "type": "received",
                                            "partner_id": partner_id,
                                        ...
                                        geturl = self.get_url(
                                            provider, media_id, phone_number_id
                                        )
                                        dict = json.loads(geturl.text)
                                        decoded = self.get_media_data(
                                            dict.get("url"), provider
                                        )
                                        ...
                                        attachment_value = {
                                            ...
                                            "datas": decoded,
                                            "type": "binary",
                                            "mimetype": mes.get("image").get(
                                                "mime_type"
                                            )
                                            if mes.get("image")
                                            and mes.get("image").get("mime_type")
                                            else "image/jpeg",
                                        }
                                        attachment = (
                                        ...
                                        attachment_value = {
                                            ...
                                            "datas": decoded,
                                            "type": "binary",
                                            "mimetype": mes.get("document").get(
                                                "mime_type"
                                            )
                                            if mes.get("document")
                                            and mes.get("document").get("mime_type")
                                        ...
                                        if "context" in mes:
                                            request.env[
                                            ...
                                            ).create(
                                                {
                                                    ...
                                                    if "document" in mes
                                                    and "caption" in mes.get("document")
                                                    else "",
                                                    "message_id": messages_id,
                                                    "author_id": user_partner.id,
                                                    "type": "received",
                                        ...
                                        attachment_value = {
                                            ...
                                            "datas": decoded,
                                            "type": "binary",
                                            "mimetype": mes.get("video").get(
                                                "mime_type"
                                            )
                                            if mes.get("video")
                                            and mes.get("video").get("mime_type")
                                            else "video/mp4",
                                        }
                                        attachment = (
                                            request.env["ir.attachment"]
                                        ...
                                        attachment_value = {
                                            ...
                                            "datas": decoded,
                                            "type": "binary",
                                            "mimetype": mes.get("audio").get(
                                                "mime_type"
                                            )
                                            if mes.get("audio")
                                            and mes.get("audio").get("mime_type")
                                            else "audio/mpeg",
                                        }
                                        attachment = (
                                            request.env["ir.attachment"]
                                        ...
                                        attachment_value = {
                                            ...
                                            "datas": decoded,
                                            "type": "binary",
                                            "mimetype": mes.get("sticker").get(
                                                "mime_type"
                                            )
                                            if mes.get("sticker")
                                            and mes.get("sticker").get("mime_type")
                                            else "image/webp",
                                        }
                                        attachment = (
                                            request.env["ir.attachment"]
                                        ...
                                        if "context" in mes:
                                            request.env[
                                            ...
                                            ).create(
                                                {
                                                    ...
                                                    if "sticker" in mes
                                                    and "caption" in mes.get("sticker")
                                                    else "",
                                                    "message_id": messages_id,
                                                    "author_id": user_partner.id,
                                                    "type": "received",
                                        ...
                                        title = list(
                                            map(
                                                lambda l: mes.get("interactive").get(l),
                                                mes.get("interactive"),
                                            )
                                        )
                                        vals = {
                                        ...
                                        request.env["whatsapp.history"].sudo().create(
                                            vals
                                        )
        return wa_dict
    ...
    def _send_product_by_whatsapp(self, **kw):
        ...
        request.env["res.partner"].sudo().browse(int(kw.get("partner_id")))
        product = (
        ...
        body_message = (
            product.name
            + "\n"
            + request.env.user.company_id.currency_id.symbol
            + " "
        ...
        if channel:
            message_values = {
                ...
                "subtype_id": request.env["ir.model.data"]
                .sudo()
    ...
    def _send_pre_message_by_whatsapp(self, **kw):
        template_id = (
            request.env["wa.template"].sudo().browse(int(kw.get("template_id")))
        )
        active_model = template_id.model
        provider_id = template_id.provider_id
        wizard_rec = (
            request.env["wa.compose.message"]
            .with_context(
                active_model=active_model, active_id=int(kw.get("partner_id"))
            )
            .create(
                {
        ...
        # action = request.env.ref('tus_meta_whatsapp_base.action_wa_compose_message_wizard').read()[0]
